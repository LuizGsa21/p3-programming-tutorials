...
+function ($) {
  'use strict';
    ...
    // Total carousel items are needed to determine width
    ...
    function moveIndicator(itemIndex){
        ...
        // keep track of index of current item
        ...
        // the slider is going to be positioned based on the index of active item
        if (itemIndex == numItems - 1 || itemIndex < 0){
            indicatorPosition = containerWidth - indicatorWidth;
        } else {
  ...
  Carousel.prototype.getItemForDirection = function (direction, active) {
    ...
    var itemIndex = (activeIndex + delta) % this.$items.length;
      // Adding this in for .carousel-slider
      if ($(".carousel-slider")) {
          moveIndicator(itemIndex);
      }
